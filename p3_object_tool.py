import os, sys
import hashlib
from modules import common, p3_object_reader, p3_constants, object_stats, object_plotter
...
def main() :
    ...
    common.print_help(
        "Pikmin 3 object tool\n"
        "  This program reads Pikmin 3 area objects in a file\n"
    ...
    for a in sys.argv :
        ...
        if a.find(".png") != -1 :
            ...
            objects.extend(p3_object_reader.read_objects(input_file))
